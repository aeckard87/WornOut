...
// CreateSubCategoryByCategoryParams contains all the bound params for the create sub category by category operation
...
func (o *CreateSubCategoryByCategoryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *CreateSubCategoryByCategoryParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
