...
func (o *CreateSubCategoryByCategoryURL) WithBasePath(bp string) *CreateSubCategoryByCategoryURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateSubCategoryByCategoryURL) Build() (*url.URL, error) {
	var result url.URL
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on CreateSubCategoryByCategoryURL")
	}
...
func (o *CreateSubCategoryByCategoryURL) String() string {
...
func (o *CreateSubCategoryByCategoryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateSubCategoryByCategoryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateSubCategoryByCategoryURL")
	}
