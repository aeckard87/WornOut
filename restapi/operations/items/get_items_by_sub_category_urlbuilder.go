...
func (o *GetItemsBySubCategoryURL) WithBasePath(bp string) *GetItemsBySubCategoryURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetItemsBySubCategoryURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on GetItemsBySubCategoryURL")
	}
...
func (o *GetItemsBySubCategoryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetItemsBySubCategoryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetItemsBySubCategoryURL")
	}
