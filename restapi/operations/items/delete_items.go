...
func (fn DeleteItemsHandlerFunc) Handle(params DeleteItemsParams) middleware.Responder {
	return fn(params)
}
...
func NewDeleteItems(ctx *middleware.Context, handler DeleteItemsHandler) *DeleteItems {
	return &DeleteItems{Context: ctx, Handler: handler}
}
...
func (o *DeleteItems) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewDeleteItemsParams()
