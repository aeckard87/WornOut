...
func (o *CreateDescriptorByDetailURL) WithBasePath(bp string) *CreateDescriptorByDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateDescriptorByDetailURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on CreateDescriptorByDetailURL")
	}
...
func (o *CreateDescriptorByDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateDescriptorByDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateDescriptorByDetailURL")
	}
