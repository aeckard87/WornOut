...
func (o *GetDescriptorURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on GetDescriptorURL")
	}
...
func (o *GetDescriptorURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDescriptorURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDescriptorURL")
	}
