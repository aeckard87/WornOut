...
func (o *UpdateDescriptorURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on UpdateDescriptorURL")
	}
...
func (o *UpdateDescriptorURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateDescriptorURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateDescriptorURL")
	}
