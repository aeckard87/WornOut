...
func (o *DeleteDescriptorsByDetailURL) WithBasePath(bp string) *DeleteDescriptorsByDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteDescriptorsByDetailURL) Build() (*url.URL, error) {
	...
	var _path = "/details/{id}/descriptors"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("ID is required on DeleteDescriptorsByDetailURL")
	}
...
func (o *DeleteDescriptorsByDetailURL) String() string {
...
func (o *DeleteDescriptorsByDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDescriptorsByDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDescriptorsByDetailURL")
	}
