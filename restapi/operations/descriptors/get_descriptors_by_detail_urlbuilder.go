...
func (o *GetDescriptorsByDetailURL) WithBasePath(bp string) *GetDescriptorsByDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDescriptorsByDetailURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on GetDescriptorsByDetailURL")
	}
...
func (o *GetDescriptorsByDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDescriptorsByDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDescriptorsByDetailURL")
	}
