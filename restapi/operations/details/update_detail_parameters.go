...
// UpdateDetailParams contains all the bound params for the update detail operation
...
func (o *UpdateDetailParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
