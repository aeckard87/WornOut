...
// NewUpdateSubCategoryParamsWithTimeout creates a new UpdateSubCategoryParams object
...
// NewUpdateSubCategoryParamsWithContext creates a new UpdateSubCategoryParams object
...
// NewUpdateSubCategoryParamsWithHTTPClient creates a new UpdateSubCategoryParams object
...
/*UpdateSubCategoryParams contains all the parameters to send to the API endpoint
for the update sub category operation typically these are written to a http.Request
*/
...
func (o *UpdateSubCategoryParams) WithTimeout(timeout time.Duration) *UpdateSubCategoryParams {
...
func (o *UpdateSubCategoryParams) WithContext(ctx context.Context) *UpdateSubCategoryParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateSubCategoryParams) WithBody(body *models.SubCategory) *UpdateSubCategoryParams {
	o.SetBody(body)
	return o
}
...
func (o *UpdateSubCategoryParams) WithID(id int64) *UpdateSubCategoryParams {
	o.SetID(id)
	return o
}
...
func (o *UpdateSubCategoryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
