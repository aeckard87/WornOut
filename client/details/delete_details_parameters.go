...
// NewDeleteDetailsParams creates a new DeleteDetailsParams object
// with the default values initialized.
func NewDeleteDetailsParams() *DeleteDetailsParams {

	return &DeleteDetailsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteDetailsParamsWithTimeout creates a new DeleteDetailsParams object
...
// NewDeleteDetailsParamsWithContext creates a new DeleteDetailsParams object
...
// NewDeleteDetailsParamsWithHTTPClient creates a new DeleteDetailsParams object
...
/*DeleteDetailsParams contains all the parameters to send to the API endpoint
for the delete details operation typically these are written to a http.Request
*/
...
func (o *DeleteDetailsParams) WithContext(ctx context.Context) *DeleteDetailsParams {
	o.SetContext(ctx)
	return o
}
