...
// NewUpdateDetailParams creates a new UpdateDetailParams object
...
// NewUpdateDetailParamsWithTimeout creates a new UpdateDetailParams object
...
// NewUpdateDetailParamsWithContext creates a new UpdateDetailParams object
...
// NewUpdateDetailParamsWithHTTPClient creates a new UpdateDetailParams object
...
/*UpdateDetailParams contains all the parameters to send to the API endpoint
for the update detail operation typically these are written to a http.Request
*/
...
func (o *UpdateDetailParams) WithContext(ctx context.Context) *UpdateDetailParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateDetailParams) WithID(id int64) *UpdateDetailParams {
	o.SetID(id)
	return o
}
